...
public class Keyboard {
    ...
    /**
     * Returns the next key that was typed by the user (that the client has not already
     * processed).
     * This method should be preceded by a call to {@link #hasNextKeyPlayed()} to ensure that
     * there
     * is a next key to process. This method returns a lowercase character corresponding to the
     * key
    ...
    private class Key {
        ...
        public String toString() {
            return String
                    .format("%-2s: [%4.1f, %4.1f] x [%2.1f, %2.1f]", name, xmin, xmax, ymin,
                            ymax);
        }
    }
